 ...
 */
public class CompletedOrderFragment extends Fragment implements OrderInterface {
...
//        List<Orders> pendingOrderList = Orders.find(Orders.class, "user = ? and status = ?", user.getId().toString(), "Completed");
